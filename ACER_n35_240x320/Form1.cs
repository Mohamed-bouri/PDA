...
namespace adan
{
    public partial class Form1 : Form
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            using (Font timeFont = new Font("Tahoma", 10, FontStyle.Regular))
            ...
            using (StringFormat sf = new StringFormat())
            {
                ...
                e.Graphics.DrawString(_nextStr, statusFont, alertBrush, new RectangleF(0, 70, FORM_W, 20), sf);

                for (int i = 0; i < 6; i++)
                {
                    string timeStr = _prayers[i].Time.ToString("HH:mm");
                    e.Graphics.DrawString(timeStr, timeFont, blackBrush, 15, 95 + (i * 28));
                }
