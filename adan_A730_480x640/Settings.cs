...
namespace adan
{
    ...
    public class SettingsForm : Form
    {
        ...
        public SettingsForm(Form1 main)
        {
            ...
            lPreFajrHead.Text = "Fajr alert offset (min): - before, + after, 0 off";
            lPreFajrHead.Font = new Font("Tahoma", 7, FontStyle.Regular);
            lPreFajrHead.ForeColor = Color.FromArgb(80, 80, 80);
            lPreFajrHead.Location = new Point(12, y);
            lPreFajrHead.Size = new Size(416, 22);
            ...
            lPreFajr.Location = new Point(12, y + 4);
            ...
            preFajrBox.Font = new Font("Tahoma", 10, FontStyle.Regular);
            preFajrBox.Location = new Point(88, y);
            preFajrBox.Size = new Size(80, 36);
            ...
            lPreFajrMin.Location = new Point(174, y + 6);
            lPreFajrMin.Size = new Size(40, 24);
            this.Controls.Add(lPreFajrMin);

            Button bPreFajrMinus = new Button();
            bPreFajrMinus.Text = "-";
            bPreFajrMinus.Font = new Font("Tahoma", 10, FontStyle.Regular);
            bPreFajrMinus.Location = new Point(220, y);
            bPreFajrMinus.Size = new Size(56, 36);
            bPreFajrMinus.Click += new EventHandler(OnPreFajrMinus);
            this.Controls.Add(bPreFajrMinus);

            Button bPreFajrPlus = new Button();
            bPreFajrPlus.Text = "+";
            bPreFajrPlus.Font = new Font("Tahoma", 10, FontStyle.Regular);
            bPreFajrPlus.Location = new Point(282, y);
            bPreFajrPlus.Size = new Size(56, 36);
